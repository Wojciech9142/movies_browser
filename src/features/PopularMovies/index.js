                            ...
                            <Tile>
                                ...
                                <Wrapper genresList>
                                    {genres.genres.genres.map((genre) =>
                                        (item.genre_ids.includes(genre.id)) ? (<GenreElement key={genre.id}>{genre.name}</GenreElement>) : ""
                                    )}
                                </Wrapper>
                                ...
                                <Rates>
                                    ...
                                    <RatesAverange>{item.vote_average}</RatesAverange>
                                    <RatesCount>{item.vote_count} votes</RatesCount>
                                </Rates>
